...
export interface RecipeIngredient { name: string; amount?: string; unit?: string }
export interface Recipe { id: string; slug: string; title: string; description: string; imageUrl: string; mealType: RecipeMealType; difficulty: RecipeDifficulty; servings: number; calories: number; proteinGrams: number; carbohydrateGrams: number; fatGrams: number; preparationMinutes: number; ingredients: RecipeIngredient[]; instructions: string[] }
