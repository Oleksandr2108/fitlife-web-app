...
export interface UserPreferences { goal: FitnessGoal; preferredWorkoutDuration: 10 | 20 | 30 }
...
export interface WorkoutPlan { id: string; userId: string; createdAt: string; days: WorkoutPlanDay[] }
