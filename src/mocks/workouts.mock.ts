...
export const workoutsMock: Workout[] = [
  { id: 'workout-001', slug: 'full-body-reset', title: 'Full Body Reset', description: 'A balanced, low-impact session to wake up every major muscle group.', difficulty: 'beginner', durationMinutes: 20, category: 'full-body', equipment: [], imageUrl: 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?auto=format&fit=crop&w=900&q=80', exercises: [exercises.squat, exercises.pushup, exercises.bridge] },
  { id: 'workout-002', slug: 'strength-foundations', title: 'Strength Foundations', description: 'Build durable lower- and upper-body strength with controlled basics.', difficulty: 'beginner', durationMinutes: 30, category: 'strength', equipment: ['Dumbbells'], imageUrl: 'https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?auto=format&fit=crop&w=900&q=80', exercises: [exercises.squat, exercises.lunge, exercises.pushup] },
  { id: 'workout-003', slug: 'quick-cardio-boost', title: 'Quick Cardio Boost', description: 'A short, energetic circuit that raises your heart rate without equipment.', difficulty: 'intermediate', durationMinutes: 10, category: 'cardio', equipment: [], imageUrl: 'https://images.unsplash.com/photo-1538805060514-97d9cc17730c?auto=format&fit=crop&w=900&q=80', exercises: [exercises.climber, exercises.squat, exercises.lunge] },
  { id: 'workout-004', slug: 'core-control', title: 'Core Control', description: 'Practice steady, functional core strength and trunk control.', difficulty: 'intermediate', durationMinutes: 20, category: 'core', equipment: ['Exercise mat'], imageUrl: 'https://images.unsplash.com/photo-1566241142559-40e1dab266c6?auto=format&fit=crop&w=900&q=80', exercises: [exercises.deadBug, exercises.plank, exercises.bridge] },
  { id: 'workout-005', slug: 'mobility-unwind', title: 'Mobility Unwind', description: 'Gentle mobility work for hips, spine, and shoulders after a busy day.', difficulty: 'beginner', durationMinutes: 10, category: 'mobility', equipment: ['Exercise mat'], imageUrl: 'https://images.unsplash.com/photo-1599447421416-3414500d18a5?auto=format&fit=crop&w=900&q=80', exercises: [exercises.catCow, exercises.lunge, exercises.bridge] },
  { id: 'workout-006', slug: 'power-circuit', title: 'Power Circuit', description: 'A demanding full-body circuit for experienced movers.', difficulty: 'advanced', durationMinutes: 30, category: 'full-body', equipment: ['Dumbbells'], imageUrl: 'https://images.unsplash.com/photo-1584466977773-e625c37cdd50?auto=format&fit=crop&w=900&q=80', exercises: [exercises.climber, exercises.squat, exercises.pushup, exercises.plank] },
]
