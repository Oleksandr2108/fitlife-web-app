...
const benefits: Benefit[] = [
  {
    ...
    description: "15–30 minute sessions that fit naturally into your day.",
    icon: Clock3,
  },
  {
    title: "Personal Goals",
    description: "Choose your goal and build a simple weekly routine.",
    icon: Target,
  },
  {
    title: "Simple Nutrition",
    description: "Easy meal ideas and everyday nutrition inspiration.",
    icon: Apple,
  },
];
    ...
    <Section className="border-y border-border bg-background-secondary">
      <AppContainer>
        <SectionHeading
          ...
          title="A simpler way to stay consistent"
        />
        <motion.div
          initial="hidden"
          whileInView="visible"
