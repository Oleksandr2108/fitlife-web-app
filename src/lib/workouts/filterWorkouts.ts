...
export const workoutCategories: readonly WorkoutCategory[] = [
  "full-body",
  "strength",
  "cardio",
  "core",
...
export const workoutDifficulties: readonly WorkoutDifficulty[] = [
  "beginner",
  "intermediate",
  "advanced",
];
...
export function formatWorkoutLabel(
  value: WorkoutCategory | WorkoutDifficulty,
): string {
  return value
    .split("-")
...
export function filterWorkouts(
  ...
  return workouts.filter((workout) => {
    ...
    const matchesCategory =
      filters.category === "all" || workout.category === filters.category;
